...
export const orderSlide = createSlice({
  ...
  reducers: {
    ...
    resetCartData: (state) => {
      state.orderItems = []; // Thiết lập lại orderItems thành mảng rỗng
    },
...
export const { addOrderProduct,increaseAmount,decreaseAmount,removeOrderProduct,removeAllOrderProduct, selectedOrder,resetOrder, setCartData, resetCartData } = orderSlide.actions
