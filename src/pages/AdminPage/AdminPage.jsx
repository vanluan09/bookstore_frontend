...
const AdminPage = () => {
  ...
  const getAllOrder = async () => {
    ...
    const res = await OrderService.getAllOrder(state)
  ...
  const getAllUsers = async () => {
    ...
    const res = await UserService.getAllUser(state)
  ...
  return (
    <>
      ...
      <HeaderComponent isHiddenSearch isHiddenCart isHiddenMenuProductList isHiddenPhone />
